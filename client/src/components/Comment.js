        ...
        <div>
            <div key={currentComment.id}>
                ...
                <div className="hstack">
                    <div>
                        <small
                            className="text-body-secondary">{new Date(+currentComment.date).toLocaleString()}</small>
                    </div>

                    {currentComment.likes.includes(username) ?
                        <div className="p-2 ms-auto">
                            <a role="button" onClick={() => handleRemoveLike()}>
                        ...
                        <div className="p-2 ms-auto">
                            <a role="button" onClick={() => handleSetLike()}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                     fill="currentColor"
                    ...
                    {currentComment.dislikes.includes(username) ?
                        <div className="p-2">
                            <a role="button" onClick={() => handleRemoveDislike()}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                     fill="currentColor"
                        ...
                        <div className="p-2">
                            <a role="button" onClick={() => handleSetDislike()}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                     fill="currentColor"
